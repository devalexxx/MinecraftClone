...
#ifndef MCC_UTILS_LOGGING_H
#define MCC_UTILS_LOGGING_H
...
#	define MCC_LOG_DEBUG(fmt, ...) MCC_FMT_PRINT(MCC_LOG_FMT fmt MCC_LOG_NL, MCC_LOG_ARGS(MCC_TAG_DEBUG) __VA_OPT__(,) __VA_ARGS__)
#else
#	define MCC_LOG_DEBUG(fmt, ...)
#endif

#if MCC_LOG_LEVEL >= MCC_INFO_LEVEL
#	define MCC_LOG_INFO(fmt, ...) MCC_FMT_PRINT(MCC_LOG_FMT fmt MCC_LOG_NL, MCC_LOG_ARGS(MCC_TAG_INFO) __VA_OPT__(,) __VA_ARGS__)
#else
#	define MCC_LOG_INFO(fmt, ...)
#endif

#if MCC_LOG_LEVEL >= MCC_WARN_LEVEL
#	define MCC_LOG_WARN(fmt, ...) MCC_FMT_PRINT(MCC_LOG_FMT fmt MCC_LOG_NL, MCC_LOG_ARGS(MCC_TAG_WARN) __VA_OPT__(,) __VA_ARGS__)
#else
#	define MCC_LOG_WARN(fmt, ...)
#endif

#if MCC_LOG_LEVEL >= MCC_ERROR_LEVEL
#	define MCC_LOG_ERROR(fmt, ...) MCC_FMT_PRINT(MCC_LOG_FMT fmt MCC_LOG_NL, MCC_LOG_ARGS(MCC_TAG_ERROR) __VA_OPT__(,) __VA_ARGS__)
#else
